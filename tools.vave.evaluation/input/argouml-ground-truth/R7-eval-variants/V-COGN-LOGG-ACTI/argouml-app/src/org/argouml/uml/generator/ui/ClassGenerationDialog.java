...
public class ClassGenerationDialog extends ArgoDialog implements ActionListener {
	...
	private static final Logger LOG = Logger.getLogger(ClassGenerationDialog.class);
	...
	private void buildLanguages() {
		ArrayList<Language>tmp = new ArrayList<Language>(GeneratorManager.getInstance().getLanguages());
