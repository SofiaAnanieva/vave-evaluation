...
public class UMLActivityDiagram extends UMLDiagram {
	private static final Logger LOG = Logger.getLogger(UMLActivityDiagram.class);
	...
	@Override public FigNode drop(Object droppedObject,Point location) {
		...
		if (figNode != null) {
			...
			LOG.debug("Dropped object NOT added. This usualy means that this " + "type of object is not accepted!");
		}
		return figNode;
	}
}
