...
public class ExplorerPopup extends JPopupMenu {
	...
	public ExplorerPopup(Object selectedItem,MouseEvent me) {
		...
		if (modelElementSelected) {
			...
			if (!multiSelect) {
				if ((classifierSelected&&!relationshipSelected)||(packageSelected&&!projectModels.contains(selectedItem))||(stateVertexSelected&&activityDiagramActive)||(stateVertexSelected)||(instanceSelected&&!dataValueSelected)||nAryAssociationSelected||commentSelected) {
