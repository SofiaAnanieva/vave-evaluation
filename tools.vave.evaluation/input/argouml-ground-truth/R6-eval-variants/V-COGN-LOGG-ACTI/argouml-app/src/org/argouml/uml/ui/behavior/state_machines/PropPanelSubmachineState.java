...
public class PropPanelSubmachineState extends PropPanelCompositeState {
	...
	public PropPanelSubmachineState() {
		...
		final JComboBox submachineBox = new UMLComboBox2(new UMLSubmachineStateComboBoxModel(),ActionSetSubmachineStateSubmachine.getInstance());
		addField("label.submachine",new UMLComboBoxNavigator(Translator.localize("tooltip.nav-submachine"),submachineBox));
