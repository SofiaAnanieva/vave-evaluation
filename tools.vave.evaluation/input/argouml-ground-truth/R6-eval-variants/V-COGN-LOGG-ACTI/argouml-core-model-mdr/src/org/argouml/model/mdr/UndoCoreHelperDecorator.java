...
@SuppressWarnings("deprecation")class UndoCoreHelperDecorator extends AbstractCoreHelperDecorator {
	...
	@Override public void setChangeability(final Object handle,Object ck) {
		createCommand(new ObjectSetter() {
			public void set(Object value) {
	...
	@Override public void setReadOnly(final Object handle,boolean flag) {
		createCommand(new BooleanSetter() {
			public void set(boolean value) {
	...
	@Override public void setTargetScope(final Object handle,Object scopeKind) {
		createCommand(new ObjectSetter() {
			public void set(Object value) {
	...
	@Override public void setVisibility(final Object handle,Object visibility) {
		createCommand(new ObjectSetter() {
			public void set(Object value) {
