...
public class FigAttribute extends FigFeature {
	@SuppressWarnings("deprecation")@Deprecated public FigAttribute(int x,int y,int w,int h,Fig aFig,NotationProvider np) {
		super(x,y,w,h,aFig,np);
	}
	@Deprecated@SuppressWarnings("deprecation")public FigAttribute(Object owner,Rectangle bounds,DiagramSettings settings,NotationProvider np) {
